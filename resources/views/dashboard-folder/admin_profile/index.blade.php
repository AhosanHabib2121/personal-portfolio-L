                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img  src="{{asset('upload-photos/admin-profile-photo')}}/{{auth()->user()->profile_photo}}" alt="your image" style="width: 200px;height:auto;"/><br>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="card-body">
                        ...
                        <div class="settings-form">
                            ...
                            <form action="{{route('change_password')}}" method="POST">
                                ...
                                <button class="btn btn-success btn-square btn-sm mt-2" type="submit">Change Password</button>
                            </form>
                        </div>
                    </div>
                </div>
