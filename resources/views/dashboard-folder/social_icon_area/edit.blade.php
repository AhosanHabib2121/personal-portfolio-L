        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('social_icons.update',$social_icon_edit)}}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="icon_input" type="text" name="social_icon" value="{{$social_icon_edit->social_icon}}" class="form-control @error('social_icon') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('social_icon')
                                    ...
                                    <div class="mt-2" style="height: 150px; overflow-y:scroll;">
                                        ...
                                        @foreach ($all_icons as $all_icon)
                                            <i id="{{$all_icon}}" class="social_icon_click m-1 p-2 border fab {{$all_icon}}" aria-hidden="true"></i>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="social_link" value="{{$social_icon_edit->social_link}}" class="form-control @error('social_link') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('social_link')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
...
@section('dashboard_js_code')
    <script>
        ...
        $(document).ready( function () {
            $('.social_icon_click').click(function(){
