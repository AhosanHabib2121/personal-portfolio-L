        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('social_icons.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Social Icon</label>
                                    <input id="icon_input" type="text" name="social_icon" class="form-control @error('social_icon') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('social_icon')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="social_link" class="form-control @error('social_link') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('social_link')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
