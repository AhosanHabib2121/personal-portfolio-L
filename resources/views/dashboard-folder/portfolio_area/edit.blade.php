        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('potfolio.update',$porfolio_edit_data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="category_id"  id="category_dropdwon" class="form-control @error('category_id') is-invalid @enderror" style="border-color:#94a4b9;" id="">
                                        <option value="">-Select one category-</option>
                                        @foreach ($category_all_data as $category_data )
                                            <option {{($porfolio_edit_data->category_id == $category_data->id)?'selected':''}} value="{{$category_data->id}}">{{$category_data->category_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" name="title" value="{{$porfolio_edit_data->title}}"  class="@error('title') is-invalid @enderror form-control" style="border-color:#94a4b9;" >
                                    @error('title')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subtitle" value="{{$porfolio_edit_data->subtitle}}"  class="@error('subtitle') is-invalid @enderror form-control" style="border-color:#94a4b9;" >
                                    @error('subtitle')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Icon</label>
                                    <input id="icon_input" type="text" name="icon" value="{{$porfolio_edit_data->icon}}"  class="form-control @error('icon') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('icon')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                    <div class="mt-2" style="height: 150px; overflow-y:scroll;">
                                        ...
                                        @foreach ($all_icons as $all_icon)
                                            <i id="{{$all_icon}}" class="icon_click m-1 p-2 border fab {{$all_icon}}" aria-hidden="true"></i>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="old_thumbnail_photo" value="{{$porfolio_edit_data->thumbnail_photo}}"><br>
                                    <img  src="{{asset('upload-photos/portfolio_photo')}}/{{$porfolio_edit_data->thumbnail_photo}}" alt="your image" style="width: 200px;height:auto;"/><br>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <img class="hidden mt-2" id="thumbnail_photo_viewer" style="width: 200px;height:auto;" src="#" alt="your image" /><br>
                                    <small>size:356x381</small><br>
                                </div>
                            </div>
                        </div>
...
@section('dashboard_js_code')
    <script>
        ...
        //thumbnail_photo_viewer show code start here
        function readURL(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function (e) {
                $('#thumbnail_photo_viewer').attr('src', e.target.result).width(150).height(195);
                };
                $('#thumbnail_photo_viewer').removeClass('hidden');
                reader.readAsDataURL(input.files[0]);
            }
        }
        //thumbnail_photo_viewer show code end here
    </script>
@endsection
