        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('potfolio.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subtitle" class="@error('subtitle') is-invalid @enderror form-control" style="border-color:#94a4b9;" >
                                    @error('subtitle')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Icon</label>
                                    <input id="icon_input" type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('icon')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
