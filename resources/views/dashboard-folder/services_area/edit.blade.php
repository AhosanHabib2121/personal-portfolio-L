        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('services.update',$services_edit_data->id)}}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Icon</label>
                                    <input id="icon_input" type="text" name="icon" value="{{$services_edit_data->icon}}" class="form-control @error('icon') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                    @error('icon')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" name="title" value="{{$services_edit_data->title}}" class="@error('title') is-invalid @enderror form-control" style="border-color:#94a4b9;" >
                                    @error('title')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description" value="{{$services_edit_data->short_description}}" id="text_show" class="@error('short_description') is-invalid @enderror form-control" style="border-color:#94a4b9;"  rows="4"></textarea>
...
@section('dashboard_js_code')
    <script>
        ...
        $(document).ready(function(){
            var textContent="{{$services_edit_data->short_description}}";
