                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            {{-- some_of_project_part --}}
                            <li>
                                <a href="#some_project" data-bs-toggle="collapse">
                                    <i class="fa fa-folder" aria-hidden="true"></i>
                                    <span>Some Of Project</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="some_project">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{route('some_project.create')}}">Create</a>
                                            <a href="{{route('some_project.index')}}">Index</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
